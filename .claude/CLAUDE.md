...
_Repo-local guidance for `logpile` goes here._

## Cross-package context

This repo is part of the **plant family** in the `traitecoevo` org (the content-addressed simulation cache). For
...
keep this file about `logpile`-local matters.
